...
[
    ...
    foreach($gces as $staffType => $staffDetails)
    {
        ...
        {
                echo "<tr>";
                echo "<td width = 20% bgcolor = 'khaki' >$staffType</td>";
                echo "<td width = 20% bgcolor = 'Bisque' >$staff[Name]</td>";
                echo "<td width = 20% bgcolor = 'MistyRose' >$staff[Address]</td>";
                echo "<td width = 20% bgcolor = 'LightCyan'>";
